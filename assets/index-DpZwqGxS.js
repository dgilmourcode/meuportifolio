(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function o(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=o(a);fetch(a.href,i)}})();var u={scrollThrottle:100,animationThreshold:.1,navbarOffset:50,mobileMenuBreakpoint:768},g={passive:!0};function y(e,t){let o;return function(...s){o||(e.apply(this,s),o=!0,setTimeout(()=>o=!1,t))}}function x(){const e=document.getElementById("spotlight");if(!e)return;let t=null;document.addEventListener("mousemove",o=>{t||(t=requestAnimationFrame(()=>{e.style.left=`${o.clientX}px`,e.style.top=`${o.clientY}px`,t=null}))},g)}function w(){const e=document.getElementById("scroll-progress");e&&window.addEventListener("scroll",()=>{const t=document.documentElement.scrollTop/(document.documentElement.scrollHeight-document.documentElement.clientHeight)*100;e.style.width=`${t}%`},g)}function L(){document.querySelectorAll(".tilt-card").forEach(e=>{e.addEventListener("mousemove",t=>{const o=e.getBoundingClientRect(),s=t.clientX-o.left,a=t.clientY-o.top,i=o.width/2,l=(a-o.height/2)/15,d=(i-s)/15;e.style.transform=`perspective(1000px) rotateX(${l}deg) rotateY(${d}deg) translateY(-4px)`}),e.addEventListener("mouseleave",()=>{e.style.transform="perspective(1000px) rotateX(0) rotateY(0) translateY(0)"})})}function E(){document.querySelectorAll(".magnetic-btn").forEach(e=>{e.addEventListener("mousemove",t=>{const o=e.getBoundingClientRect(),s=t.clientX-o.left-o.width/2,a=t.clientY-o.top-o.height/2;e.style.transform=`translate(${s*.3}px, ${a*.3}px)`}),e.addEventListener("mouseleave",()=>{e.style.transform="translate(0, 0)"})})}function S(){const e={threshold:u.animationThreshold,rootMargin:"0px 0px -50px 0px"},t=new IntersectionObserver(o=>{o.forEach(s=>{s.isIntersecting&&(s.target.classList.add("visible"),t.unobserve(s.target))})},e);document.querySelectorAll(".fade-in-section").forEach((o,s)=>{o.style.setProperty("--delay",`${s*100}ms`),t.observe(o)})}function A(){document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",function(t){t.preventDefault();const o=this.getAttribute("href");if(o==="#")return;const s=document.querySelector(o);if(s){const a=document.querySelector("nav"),i=a?a.offsetHeight:0,l=s.getBoundingClientRect().top+window.pageYOffset-i-20;window.scrollTo({top:l,behavior:"smooth"}),p()}})})}function M(){const e=document.getElementById("mobile-menu-btn"),t=document.getElementById("mobile-menu-close"),o=document.getElementById("mobile-menu"),s=document.querySelectorAll(".mobile-nav-link");!e||!o||(e.addEventListener("click",k),t&&t.addEventListener("click",p),s.forEach(a=>{a.addEventListener("click",p)}))}function k(){const e=document.getElementById("mobile-menu");e&&(e.classList.add("open"),document.body.style.overflow="hidden")}function p(){const e=document.getElementById("mobile-menu");e&&(e.classList.remove("open"),document.body.style.overflow="")}function C(){const e=document.querySelectorAll("section[id]"),t=document.querySelectorAll(".nav-link"),o=new IntersectionObserver(s=>{s.forEach(a=>{if(a.intersectionRatio>.5){const i=a.target.getAttribute("id");t.forEach(l=>{const d=l.getAttribute("href")===`#${i}`;l.classList.toggle("active",d),l.classList.toggle("text-white",d),l.classList.toggle("text-text-muted",!d)})}})},{threshold:[0,.25,.5,.75,1],rootMargin:"-20% 0px -60% 0px"});e.forEach(s=>o.observe(s))}function I(){const e=document.getElementById("navbar");if(!e)return;let t=0;const o=y(()=>{const s=window.pageYOffset;requestAnimationFrame(()=>{s>u.navbarOffset?e.classList.add("scrolled"):e.classList.remove("scrolled"),s>t&&s>500?e.style.transform="translateY(-100%)":e.style.transform="translateY(0)"}),t=s},u.scrollThrottle);window.addEventListener("scroll",o,g)}function T(){const e=document.querySelectorAll(".filter-btn"),t=document.querySelectorAll(".project-card");e.forEach(o=>{o.addEventListener("click",()=>{j(o);const s=o.getAttribute("data-filter");t.forEach(a=>{if(s==="all")v(a);else{const i=a.getAttribute("data-category");i&&i.includes(s)?v(a):P(a)}})})})}function j(e){document.querySelectorAll(".filter-btn").forEach(t=>{t.classList.remove("active","bg-accent","text-white","shadow-lg"),t.classList.add("bg-white/5","border","border-white/10","text-text-muted")}),e.classList.remove("bg-white/5","border","border-white/10","text-text-muted"),e.classList.add("active","bg-accent","text-white","shadow-lg")}function v(e){e.classList.remove("hidden"),requestAnimationFrame(()=>{e.style.opacity="1",e.style.transform="translateY(0)"})}function P(e){e.style.opacity="0",e.style.transform="translateY(20px)",setTimeout(()=>{e.classList.add("hidden")},300)}function $(){const e=document.getElementById("year");e&&(e.textContent=new Date().getFullYear())}document.addEventListener("DOMContentLoaded",function(){x(),w(),A(),M(),C(),I(),S(),L(),E(),T(),$(),console.log("✅ Portfolio initialized successfully")});function D(){const e=document.getElementById("projects-section-container"),t=document.getElementById("projects-carousel"),o=document.getElementById("carousel-dots");if(!t||!o||!e)return;t.innerHTML="",o.innerHTML="";const s=[{title:"Dashboard Operacional",category:"Data & BI",shortDesc:"KPIs em tempo real.",fullDesc:"Ecossistema de dashboards Power BI conectados ao SQL. Automação de relatórios manuais, economizando 15h/semana da equipe.",metrics:[{label:"Redução Tempo",value:"70%",icon:"fa-clock"},{label:"Economia",value:"15h",icon:"fa-coins"}],image:"/assets/img-projetos/dashboard-inteligente.jpg",tags:["Power BI","SQL","ETL"],link:"#contato"},{title:"AppSheet Processos Ágeis",category:"Low-Code",shortDesc:"Sistemas Mobile Otimizados.",fullDesc:"App mobile low-code para equipes de campo. Sincronização offline/online com Google Sheets, garantindo dados precisos em tempo real.",metrics:[{label:"Usuários",value:"85+",icon:"fa-users"},{label:"Uptime",value:"99%",icon:"fa-server"}],image:"/assets/img-projetos/appsheet-gestao.jpg",tags:["AppSheet","Mobile"],link:"https://wa.me/5586994936797"},{title:"Otimização Logística",category:"Processos",shortDesc:"Lean & Dados.",fullDesc:"Análise de gargalos logísticos via Lean Six Sigma. Otimização de rotas e carga, aumentando eficiência em 40%.",metrics:[{label:"Eficiência",value:"+40%",icon:"fa-chart-line"},{label:"Entregas",value:"500+",icon:"fa-truck-fast"}],image:"/assets/img-projetos/otimizacao-logistica.jpg",tags:["Lean","Logística"],link:"#contato"},{title:"Governança de Dados",category:"Automação",shortDesc:"Python & Pandas.",fullDesc:"Scripts Python para validação e limpeza automática de grandes volumes de dados. Relatórios de integridade diários por e-mail.",metrics:[{label:"Auto",value:"100%",icon:"fa-robot"},{label:"Emails",value:"30+",icon:"fa-envelope"}],image:"/assets/img-projetos/governanca-dados.jpg",tags:["Python","Pandas"],link:"#contato"},{title:"Monitoramento Sistemas",category:"Sistemas",shortDesc:"Custos & Performance.",fullDesc:"Painel de monitoramento proativo de hardware e serviços. Redução de 80% nos custos de manutenção corretiva.",metrics:[{label:"Custos",value:"-80%",icon:"fa-money-bill-wave"},{label:"Uptime",value:"99.9%",icon:"fa-heart-pulse"}],image:"/assets/img-projetos/monitoramento-operacional.jpg",tags:["Infra","Monitoramento"],link:"#contato"}],a=["Todos",...new Set(s.map(n=>n.category))],i=document.createElement("div");i.className="flex gap-2 overflow-x-auto pb-4 mb-6 scrollbar-hide w-full px-1",i.style.scrollbarWidth="none",i.style.msOverflowStyle="none",i.innerHTML=a.map(n=>`
    ...
    `).join(""),t.addEventListener("scroll",m),d.forEach(n=>{n.addEventListener("click",c=>{const r=parseInt(c.target.dataset.index);t.scrollTo({left:r*272,behavior:"smooth"})})}),m()}window.openCompactModal=function(e){const t=[{title:"Dashboard Operacional",category:"Data & BI",fullDesc:"Ecossistema de dashboards Power BI conectados ao SQL. Automação de relatórios manuais, economizando 15h/semana da equipe. Implementação de KPIs de eficiência operacional em tempo real.",metrics:[{label:"Redução Tempo",value:"70%"},{label:"Economia",value:"15h"}],image:"/assets/img-projetos/dashboard-inteligente.jpg",tags:["Power BI","SQL","ETL"],link:"#contato"},{title:"AppSheet Gestão",category:"Low-Code",fullDesc:"App mobile low-code para equipes de campo. Sincronização offline/online com Google Sheets, garantindo dados precisos em tempo real. Redução de erros de digitação em 90%.",metrics:[{label:"Usuários",value:"85+"},{label:"Uptime",value:"99%"}],image:"/assets/img-projetos/appsheet-gestao.jpg",tags:["AppSheet","Mobile"],link:"https://wa.me/5586994936797"},{title:"Otimização Logística",category:"Processos",fullDesc:"Análise de gargalos logísticos via Lean Six Sigma. Otimização de rotas e carga, aumentando eficiência em 40%. Integração com sistemas de rastreamento.",metrics:[{label:"Eficiência",value:"+40%"},{label:"Entregas",value:"500+"}],image:"/assets/img-projetos/otimizacao-logistica.jpg",tags:["Lean","Logística"],link:"#contato"},{title:"Governança de Dados",category:"Automação",fullDesc:"Scripts Python para validação e limpeza automática de grandes volumes de dados. Relatórios de integridade diários por e-mail. Padronização de nomenclatura e formatos.",metrics:[{label:"Auto",value:"100%"},{label:"Emails",value:"30+"}],image:"/assets/img-projetos/governanca-dados.jpg",tags:["Python","Pandas"],link:"#contato"},{title:"Monitoramento Sistemas",category:"Sistemas",fullDesc:"Painel de monitoramento proativo de hardware e serviços. Redução de 80% nos custos de manutenção corretiva. Alertas automáticos via Slack/E-mail.",metrics:[{label:"Custos",value:"-80%"},{label:"Uptime",value:"99.9%"}],image:"/assets/img-projetos/monitoramento-operacional.jpg",tags:["Infra","Monitoramento"],link:"#contato"}][e],o=document.createElement("div");o.className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 opacity-0 transition-opacity duration-300",o.innerHTML=`
